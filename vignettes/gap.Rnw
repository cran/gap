...
Based on data on chicken genome scan, the code below illustrates the use of gaps to separate chromosomes.
...
\includegraphics[height=16cm,width=18cm]{figures/4w.png}
